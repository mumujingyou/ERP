...
public class XuanZeZhanghuActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xuan_ze_zhanghu);
        initView();
    ...
    void initView(){
        backBtn=findViewById(R.id.xuanzezhanghu_back);
        radioGroup=findViewById(R.id.xuanzezhanghu_radioGroup);
        ...
        if((boolean)(map.get("isSuccess"))){
            ...
            try {
                ...
                for (int i=0;i<jsonArray.length();i++){
                    ...
                    String name=jsonObject.getString("acName");
