...
public class XiaoshoudanXiangqingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xiaoshoudan_xiangqing);
        initView();
    }
    ...
    void initView(){
        ...
        shishoujineText=findViewById(R.id.shifujine);
    ...
    void loadModle() throws JSONException {
        ...
        if ((boolean) (map.get("isSuccess"))) {
            ...
            busScopeId=json.getString("busScope");
            fccAmount=json.getString("recAmount");
            Log.d("recAmount", fccAmount);
            createTime=json.getString("createTime");
            createBy=json.getString("creatorName");
            outDepotName=json.getString("outDepotName");
            ...
            final String busScopeName=getBuscopeName();

            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    loadView(sellNo,busTime,leader,custName,otherAmount,remarks,totalAmount,busScopeName,fccAmount,createTime,createBy,outDepotName);
                    loadListView();
                }
            });
            getJsonIds();
    ...
    String getBuscopeName() throws JSONException {
        final String contentType = "application/x-www-form-urlencoded";
        final String url = UserBaseDatus.getInstance().url + "api/app/settleAccount/getSettleAccountById";
        final String data = "signa=" + UserBaseDatus.getInstance().getSign() + "&&id=" + busScopeId;
        Map map = UserBaseDatus.getInstance().isSuccessPost(url, data, contentType);
        if ((boolean) (map.get("isSuccess"))) {
            JSONObject jsonObject=(JSONObject) map.get("json");
            ...
            String acName=json.getString("acName");
            return acName;
        }
        return "";
    ...
    private void loadView(String buyNo, String busTime,
                          ...
                          String busScopeName, String fccAmount, String createTime,String createBy,String cangku) {
        danhaoText.setText(buyNo);
        yewuriqiText.setText(busTime);
        leaderText.setText(leader);
        kehuText.setText(supplierName);
        otherCaseText.setText("￥"+otherAmount);
        remarksText.setText(remarks);
        totalAmountText.setText("￥"+totalAmount);
        jiesuanzhanghuText.setText(busScopeName);
        shishoujineText.setText("￥"+fccAmount);
    ...
    void loadListView(){
        ...
        adapter=new CommonAdapter<ShangpinBaseDatus>(XiaoshoudanXiangqingActivity.this,lists, R.layout.item_jinhuoxiangqing_shangpin) {
    ...
    Dialog dialog;
    void showImage(){
        dialog = new Dialog(XiaoshoudanXiangqingActivity.this, R.style.AlertDialog_AppCompat_Light);
