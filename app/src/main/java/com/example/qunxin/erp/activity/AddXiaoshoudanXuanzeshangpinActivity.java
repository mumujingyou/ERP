...
public class AddXiaoshoudanXuanzeshangpinActivity extends AppCompatActivity {
        ...
        enterBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isAuto==false){
                    ...
                    Intent intent=new Intent(AddXiaoshoudanXuanzeshangpinActivity.this,AddXiaoshoudanAfterActivity.class);
  ...
  */
    ...
    String JsonParse()  {
        ...
        for (int i=0;i<lists.size();i++){
            ...
            try {
                ...
                jsonObject.put("sellPrice",lists.get(i).getPrice());
                ...
                jsonObject.put("sellTotal",lists.get(i).getTotal());
                ...
                jsonObject.put("id","");
                jsonObject.put("sellId","");
                jsonObject.put("sellNo",busNo);
    ...
    void loadModelType(){
        ...
        AddXiaoshoudanXuanzeshangpinActivity.TypeNameClass typeNameClass=new AddXiaoshoudanXuanzeshangpinActivity.TypeNameClass();
        ...
        if((boolean)(map.get("isSuccess"))){
            ...
            try {
                ...
                for (int i=0;i<jsonArray.length();i++){
                    ...
                    AddXiaoshoudanXuanzeshangpinActivity.TypeNameClass typeNameClass1=new AddXiaoshoudanXuanzeshangpinActivity.TypeNameClass();
    ...
    void loadViewType(){
        ...
        shangpinType.setAdapter(new CommonAdapter<TypeNameClass>(AddXiaoshoudanXuanzeshangpinActivity.this,typeNameLists, R.layout.item_shangpintype) {
    ...
    void loadViewShangpin(){
        ...
        shangpinsListView.setAdapter(new CommonAdapter<ShangpinBaseDatus>(AddXiaoshoudanXuanzeshangpinActivity.this,lists, R.layout.item_addcaigoudingdan_xuanzeshangpin) {
        ...
        finishBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(count>datus.getMaxTotal()){
                    ...
                    Toast.makeText(AddXiaoshoudanXuanzeshangpinActivity.this, "已经设置成最大库存数量", Toast.LENGTH_SHORT).show();
                }
