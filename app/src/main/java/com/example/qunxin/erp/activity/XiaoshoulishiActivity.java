...
public class XiaoshoulishiActivity extends AppCompatActivity implements TextWatcher, View.OnClickListener, AbsListView.OnScrollListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xiaoshoulishi);
    ...
    void loadView(){
        ...
        if(adapter==null){
            adapter=new CommonAdapter<JinhuoBaseDatus>(XiaoshoulishiActivity.this,lists, R.layout.item_xiaoshoulishi) {
                ...
                public void convert(final ViewHolder holder, final JinhuoBaseDatus jinhuoBaseDatus, final int position, View convertView) {
                    ...
                    holder.setText(R.id.totalAmount,jinhuoBaseDatus.getTotalAmount());

                    TextView textView=holder.getView(R.id.textView);
                    if(jinhuoBaseDatus.getStatus().equals("1")){
                        textView.setText("退款");
                        textView.setBackgroundColor(Color.parseColor("#E95B4E"));
                    }else {
                        textView.setText("正常");
                        textView.setBackgroundColor(Color.parseColor("#69d065"));
                    }
                    ...
                    holder.setOnClickListener(R.id.ll_content, new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent intent=new Intent(XiaoshoulishiActivity.this,XiaoshoudanXiangqingActivity.class);
                            isLoad=true;
    ...
    void delete(final int position){
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                final String strUrl = UserBaseDatus.getInstance().url+"api/sells/remove";
                final String strData = "ids="+datus.getId()+"&&signa="+UserBaseDatus.getInstance().getSign()+"&&userId="+
                        UserBaseDatus.getInstance().userId;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.back:
                Intent intent1=new Intent(XiaoshoulishiActivity.this,MainActivity.class);
                startActivity(intent1);
                finish();
                break;
            case R.id.add:
                Intent intent=new Intent(XiaoshoulishiActivity.this,AddXiaoshoudanActivity.class);
                isLoad=true;
                startActivity(intent);
                break;
        }
