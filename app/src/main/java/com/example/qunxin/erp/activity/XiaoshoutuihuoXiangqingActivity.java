...
public class XiaoshoutuihuoXiangqingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xiaoshoutuihuo_xiangqing);
        initView();
    }
    ...
    void loadModle() throws JSONException {
        ...
        final String url = UserBaseDatus.getInstance().url + "api/rejects/selectById";
        ...
        if ((boolean) (map.get("isSuccess"))) {
            ...
            JSONObject json=json1.getJSONObject("reject");
            buyNo=json.getString("rejectNo");
            busTime=json.getString("busTime");
            leader=json.getString("leader");
            kehuName=json.getString("custName");
            ...
            depotName=json.getString("inDepotName");


            JSONArray jsonArray= json1.getJSONArray("rejectDetailList");
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    loadView(buyNo,busTime,leader,kehuName,otherAmount,remarks,totalAmount,busScope,recAmount,createTime,createBy,depotName);
                    loadListView();
                }
            });
    ...
    private void loadView(String buyNo, String busTime,
                          String leader, String kehuName, String otherAmount, String remarks, String totalAmount,
    ...
    void loadListView(){
        ...
        adapter=new CommonAdapter<ShangpinBaseDatus>(XiaoshoutuihuoXiangqingActivity.this,lists, R.layout.item_jinhuoxiangqing_shangpin) {
    ...
    Dialog dialog;
    void showImage(){
        dialog = new Dialog(XiaoshoutuihuoXiangqingActivity.this, R.style.AlertDialog_AppCompat_Light);
