...
public class XiaoshoutuihuolishiActivity extends AppCompatActivity implements AbsListView.OnScrollListener, TextWatcher {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xiaoshoutuihuolishi);
    ...
    void initView() {
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(XiaoshoutuihuolishiActivity.this,MainActivity.class);
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(XiaoshoutuihuolishiActivity.this,AddXiaoshoutuihuodanActivity.class);
                isLoad=true;
                startActivity(intent);
            }
        });
    ...
    void loadModel(int index) {
        ...
        final String url = UserBaseDatus.getInstance().url + "api/rejects/list";
        Map<String, String> jsonMap = new HashMap<>();
        jsonMap.put("rejectNo",searchValue);
        ...
        if ((boolean) (map.get("isSuccess"))) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    String refundNo = jsonObject.getString("rejectNo");
    ...
    void loadView() {
        ...
        if(adapter==null){
            adapter=new CommonAdapter<JinhuotuihuoBaseDatus>(XiaoshoutuihuolishiActivity.this, lists, R.layout.item_xiaoshoutuihuolishi) {
                ...
                public void convert(final ViewHolder holder, JinhuotuihuoBaseDatus jinhuotuihuoBaseDatus, final int position, View convertView) {
                    ...
                    holder.setText(R.id.kehu, jinhuotuihuoBaseDatus.getKehuName());
                    ...
                    holder.setOnClickListener(R.id.ll_content, new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            isLoad=true;
                            Intent intent = new Intent(XiaoshoutuihuolishiActivity.this, XiaoshoutuihuoXiangqingActivity.class);
    ...
    void delete(final int position){
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                final String strUrl = UserBaseDatus.getInstance().url+"api/rejects/appDeleteRefund";
