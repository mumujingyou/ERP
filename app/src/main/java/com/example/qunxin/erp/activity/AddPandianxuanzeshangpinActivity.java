...
public class AddPandianxuanzeshangpinActivity extends AppCompatActivity {
        ...
        enterBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isAuto==false){
                    ...
                    Intent intent=new Intent(AddPandianxuanzeshangpinActivity.this,AddPandiancangkuAfterActivity.class);
    ...
    String JsonParse()  {
        ...
        for (int i=0;i<lists.size();i++){
            ...
            try {
                if(lists.get(i).getActualTotal()==0) continue;
                jsonObject.put("proId",lists.get(i).getProId());
                jsonObject.put("actualTotal",lists.get(i).getActualTotal());
    ...
    void loadModelType(){
        ...
        AddPandianxuanzeshangpinActivity.TypeNameClass typeNameClass=new AddPandianxuanzeshangpinActivity.TypeNameClass();
        ...
        if((boolean)(map.get("isSuccess"))){
            ...
            try {
                ...
                for (int i=0;i<jsonArray.length();i++){
                    ...
                    AddPandianxuanzeshangpinActivity.TypeNameClass typeNameClass1=new AddPandianxuanzeshangpinActivity.TypeNameClass();
    ...
    //左边分类
    List<AddPandianxuanzeshangpinActivity.TypeNameClass> typeNameLists=new ArrayList<>();
    class TypeNameClass{
    ...
    void loadViewType(){
        ...
        shangpinType.setAdapter(new CommonAdapter<AddPandianxuanzeshangpinActivity.TypeNameClass>(AddPandianxuanzeshangpinActivity.this,typeNameLists, R.layout.item_shangpintype) {

            @Override
            public void convert(final ViewHolder holder, final AddPandianxuanzeshangpinActivity.TypeNameClass typeName, final int position, View convertView) {
        ...
        if((boolean)(map.get("isSuccess"))){
            ...
            try {
                ...
                for (int i=0;i<jsonArray.length();i++){
                    ...
                    String bookTotal=jsonObject.getString("stockTotal");
                    if(bookTotal.equals("null")){
                        continue;
                    }

                    if(bookTotal.equals("0")){
                        continue;
                    }
                    ...
                    datus.setUnit(unit);
                    datus.setBookTotal(Integer.parseInt(bookTotal));
                    lists.add(datus);
    ...
    void loadViewShangpin(){
        ...
        shangpinsListView.setAdapter(new CommonAdapter<ShangpinBaseDatus>(AddPandianxuanzeshangpinActivity.this,lists, R.layout.item_addcaigoudingdan_xuanzeshangpin) {
            ...
            public void convert(final ViewHolder holder, ShangpinBaseDatus shangpinDatus, final int position, View convertView) {
                ...
                holder.setText(R.id.etAmount,shangpinDatus.getActualTotal()+"");
                holder.setOnClickListener(R.id.ll_content, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        show(datus.getProName(),datus.getBookTotal()+"", position,etAmount);
                    }
                });
    ...
    public void show(String name, final String bookTotal, final int position, final TextView countText){
        dialog = new Dialog(this,R.style.ActionSheetDialogStyle);
        //填充对话框的布局
        LinearLayout inflate =(LinearLayout) LayoutInflater.from(this).inflate(R.layout.bottom_dialog_pandianshangpin, null);
        //初始化控件
        TextView nameText = (TextView) inflate.findViewById(R.id.name);
        TextView bookTotalText = (TextView) inflate.findViewById(R.id.bookTotal);
        final TextView actualTotalText = (TextView) inflate.findViewById(R.id.actualTotal);

        View finishBtn=inflate.findViewById(R.id.finish);
        nameText.setText(name);
        bookTotalText.setText(bookTotal);
        ...
        finishBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if("".equals(actualTotalText.getText().toString())) return;
                int actualTotal=Integer.parseInt(actualTotalText.getText().toString());
                ShangpinBaseDatus datus=lists.get(position);
                countText.setText(actualTotal+"");
    ...
    int caculateCount(){
        int sumCount=0;
        for (int i=0;i<lists.size();i++){
            sumCount+=lists.get(i).getActualTotal();
        }
        return sumCount;
    }
