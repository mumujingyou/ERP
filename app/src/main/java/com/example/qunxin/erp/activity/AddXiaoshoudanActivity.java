...
public class AddXiaoshoudanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_xiaoshoudan);
    ...
    void initView(){
        ...
        kehuText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(AddXiaoshoudanActivity.this,XuanzeKehuActivity.class);
        ...
        depotNameText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(AddXiaoshoudanActivity.this,XuanzeCangkuActivity.class);
                startActivityForResult(intent,1);
            }
        });
        ...
        shangpinText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(kehuName.equals("")||depotName.equals("")){
                    Toast.makeText(AddXiaoshoudanActivity.this, "客户和仓库不能为空", Toast.LENGTH_SHORT).show();
                    return;
                }
                Intent intent=new Intent(AddXiaoshoudanActivity.this,AddXiaoshoudanXuanzeshangpinActivity.class);
    ...
    void getBianhao(){
        UserBaseDatus.getInstance().getShangpinbianhao("13",AddXiaoshoudanActivity.this,danhaoText);
    }
}
