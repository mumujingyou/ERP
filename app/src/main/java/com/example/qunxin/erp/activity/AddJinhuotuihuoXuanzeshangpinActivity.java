...
public class AddJinhuotuihuoXuanzeshangpinActivity extends AppCompatActivity {
        ...
        enterBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isAuto==false){
                    ...
                    Intent intent=new Intent(AddJinhuotuihuoXuanzeshangpinActivity.this,AddJinhuotuihuodanAfterActivity.class);
...
//        ids.add("");
    ...
    void loadViewType(){
        ...
        shangpinType.setAdapter(new CommonAdapter<TypeNameClass>(AddJinhuotuihuoXuanzeshangpinActivity.this,typeNameLists, R.layout.item_shangpintype) {
        ...
        if((boolean)(map.get("isSuccess"))){
            ...
            try {
                ...
                for (int i=0;i<jsonArray.length();i++){
                    ...
                    String id=jsonObject.getString("id");//商品id
...
//                    int stockTotal=jsonObject.getInt("stockTotal");
//                    if((stockTotal+"").equals("null")){
//                        continue;
//                    }


                    String stockTotalStr=jsonObject.getString("stockTotal");

                    if(stockTotalStr.equals("null")){
                        continue;
                    }
                    if(stockTotalStr.equals("0")){
                        continue;
                    }
    ...
    void loadViewShangpin(){
        ...
        shangpinsListView.setAdapter(new CommonAdapter<ShangpinBaseDatus>(AddJinhuotuihuoXuanzeshangpinActivity.this,lists, R.layout.item_addcaigoudingdan_xuanzeshangpin) {
                ...
                etAmount.addTextChangedListener(new TextWatcher() {
                    ...
                    public void afterTextChanged(Editable s) {
                        ...
                        if(amount[0]>datus.getMaxTotal()){
                            ...
                            holder.setText(R.id.etAmount, amount[0] +"");
                            Toast.makeText(mContext, "已经设置成最大值", Toast.LENGTH_SHORT).show();
                        }
                        datus.setTotal(Integer.parseInt(etAmount.getText().toString()));
                        TextChange();
    ...
    public void show(String name, final String price, final int position, final TextView countTextView, final TextView danjia){
...
//       将属性设置给窗体
        ...
        finishBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                float priceDanjia=Float.parseFloat(danjiaText.getText().toString());
                ShangpinBaseDatus datus=lists.get(position);


                if(count>datus.getMaxTotal()){
                    count=datus.getMaxTotal();
                    Toast.makeText(AddJinhuotuihuoXuanzeshangpinActivity.this, "已经设置成最大退货数量", Toast.LENGTH_SHORT).show();
                }

                Log.d("count++", count+"");
                Log.d("count++", datus.getMaxTotal()+"");


                datus.setPrice(priceDanjia);
                datus.setSellPrice(priceDanjia);
