...
public class JinhuodanXiangqiangActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jinhuodan_xiangqiang);
        initView();
    }
    ...
    void loadListView(){
        ...
        adapter=new CommonAdapter<ShangpinBaseDatus>(JinhuodanXiangqiangActivity.this,lists, R.layout.item_jinhuoxiangqing_shangpin) {
    ...
    Dialog dialog;
    void showImage(){
        dialog = new Dialog(JinhuodanXiangqiangActivity.this, R.style.AlertDialog_AppCompat_Light);
