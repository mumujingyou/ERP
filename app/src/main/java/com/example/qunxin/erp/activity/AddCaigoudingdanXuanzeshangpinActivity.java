...
public class AddCaigoudingdanXuanzeshangpinActivity extends AppCompatActivity {
    ...
    void initView(){
        ...
        enterBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isAuto==false){
                    ...
                    Intent intent=new Intent(AddCaigoudingdanXuanzeshangpinActivity.this,AddCaigoudingdanAfterActivity.class);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                 ...
                 *要执行的操作
                 */
                if(typeNameLists.get(0).getTextView()==null) return;
    ...
    void loadViewType(){
        ...
        shangpinType.setAdapter(new CommonAdapter<TypeNameClass>(AddCaigoudingdanXuanzeshangpinActivity.this,typeNameLists, R.layout.item_shangpintype) {
    ...
    void loadModelShangpin(){
        ...
        final String url= UserBaseDatus.getInstance().url+"api/app/proProduct/prolistBySub";


        String jsonString="supplier="+supplier+"&&signa="+signa+"&&pageSize="+pageSize+"&&pageNum="+pageNum+
                "&&type="+type;
    ...
    void loadViewShangpin(){
        ...
        shangpinsListView.setAdapter(new CommonAdapter<ShangpinBaseDatus>(AddCaigoudingdanXuanzeshangpinActivity.this,lists, R.layout.item_addcaigoudingdan_xuanzeshangpin) {
...
//       将属性设置给窗体
        ...
        finishBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(countText.getText().toString().equals("")||danjiaText.getText().toString().equals("")){
                    return;
                }
